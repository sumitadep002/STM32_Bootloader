...
#define EN_R_W_PROTECT           0x58
#define MEM_READ                 0x59
#define READ_SECTOR_P_STATUS     0x5A
#define OTP_READ                 0x5B
#define DIS_R_W_PROTECT          0x5C
#define MY_NEW_COMMAND           0x5D

//len details of the command
#define GET_VER_LEN              6
#define GET_HELP_LEN             6
#define GET_CID_LEN              6
#define GET_RDP_STATUS_LEN       6
#define GO_TO_ADDR_LEN           10
#define FLASH_ERASE_LEN          8
#define MEM_WRITE_LEN(x)         (7+x+4)
#define EN_R_W_PROTECT_LEN       8
#define READ_SECTOR_P_STATUS_LEN   6
#define DIS_R_W_PROTECT_LEN       6
#define MY_NEW_COMMAND_LEN        8
